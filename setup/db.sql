...
CREATE TABLE `RESULTS` (
  ...
  `anws_syserror` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `ALG_TEST_LIST`
  ...
  ADD CONSTRAINT `tests_problem_id` FOREIGN KEY (`problem_id`) REFERENCES `CONTENT` (`CONTENT_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `SUBMISSIONS`
  ADD CONSTRAINT `submission_problem_id` FOREIGN KEY (`problem_id`) REFERENCES `CONTENT` (`CONTENT_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `TEST_QUESTIONS`
  ADD CONSTRAINT `question_problem_id` FOREIGN KEY (`problem_id`) REFERENCES `CONTENT` (`CONTENT_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
